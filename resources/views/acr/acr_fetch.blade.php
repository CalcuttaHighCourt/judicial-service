		...
		<div id="info-panel-heading" class="panel-heading">FETCH ACR HISTORY</div>
            ...
            <br><br>
                ...
                <div class="form-group required row">
                    ...
                    <div id="from_assessment_year-group" class="form-group our-form-group div_add_more ">
                        <div class="col-sm-3  col-sm-offset-1">
                            <input id="from_assessment_year" type="text"
                                class="form-control info-form-control from_assessment_year date" name="from_assessment_year"> <span
                                id="from_assessment_year-span" class="help-block our-help-block"> <!-- IIIIIIIIIII -->
                        ...
                        <div class="col-sm-3  col-sm-offset-1">
                            <input id="to_assessment_year" type="text"
                                class="form-control info-form-control to_assessment_year date" name="to_assessment_year"> <span
                                id="to_assessment_year-span" class="help-block our-help-block"> <!-- IIIIIIIIIII -->
