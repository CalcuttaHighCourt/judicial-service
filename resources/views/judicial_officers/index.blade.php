...
function send_ajax_and_set_errors_exceptions_success(type){
	...
	if(type=="add"){
		...
		ajax_url="{{ action('JudicialOfficerController@update','') }}"+"/"+$("#Posting_judicial_officer_id").val();
		...
		ajax_url="{{ action('JudicialOfficerController@destroy','') }}"+"/"+$("#Posting_judicial_officer_id").val();
