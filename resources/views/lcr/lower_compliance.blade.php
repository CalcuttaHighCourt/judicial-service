            ...
            <div class="panel-body">
                ...
                <div id="memo_no-group" class="form-group our-form-group">
                    ...
                    <div class="col-sm-offset-3">
                        <span id="memo_no_forward_div" class="help-block our-help-block">{{($data['hc_records']['0']['memo_no'])}}</span>
                    </div>
                </div>
                </div>
                <div class="col-sm-12">
        ...
        <div id="info-panel" class="panel panel-deafult">
            <div class="panel-body" >
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-offset-3">
                        <span id="memo_no_comply_div" class="help-block our-help-block">{{($data['hc_records']['0']['memo_no'])}}</span>
                    </div>
                </div>
                <div class="col-sm-12">
                    <!-- IIIIIIIIIII -->
