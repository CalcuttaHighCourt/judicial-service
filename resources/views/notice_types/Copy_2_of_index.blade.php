...
<div id="info-panel" class="panel panel-default">
	...
	<div class="panel-body">
		...
		<form id="info-form" class="form-horizontal" role="form" method="POST"
			...
			<div id="notice_type-group" class="form-group our-form-group">
				<!-- IIIIIIIIIII -->
				<label for="notice_type" class="col-md-4 control-label">Notice Type</label>

				<div class="col-md-6">
					<input id="notice_type" type="text"
						class="form-control info-form-control" name="notice_type"> <span
						id="notice_type-span" class="help-block our-help-block"> <!-- IIIIIIIIIII -->
						<strong id="notice_type-strong" class="our-error-message-strong"></strong>
						<!-- IIIIIIIIIII -->
					</span>
				</div>
			</div>
			...
			<div id="path-group" class="form-group our-form-group">
				<!-- IIIIIIIIIII -->
				<label for="path" class="col-md-4 control-label">Path</label>

				<div class="col-md-6">
					<input id="path" type="text" class="form-control info-form-control"
						name="path"> <span id="path-span"
						class="help-block our-help-block"> <!-- IIIIIIIIIII --> <strong
						id="path-strong" class="our-error-message-strong"></strong> <!-- IIIIIIIIIII -->
					</span>
				</div>
			</div>
...
function populate_form(data){
	$("#info-panel-heading").html("Displaying record of Notice Type: <strong>"+data.notice_type+"</strong>");

	$("#notice_type-id").val(data.id);
	
	$("#notice_type").val(data.notice_type);
...
function send_ajax_and_set_errors_exceptions_success(type){
	...
	$.ajax({
		...
		success: function (data, textStatus, jqXHR) {
			...
			if(data.notice_type.hasOwnProperty('notice_type')){
				msg+="Notice Type: <strong>"+data.notice_type.notice_type+"</strong> successfully "+operated+".";
			}
			else{
				if(data.notice_type>=1){
					msg+="Notice Type: <strong>"+formData.notice_type+"</strong> successfully "+operated+".";
				}
				else{
					msg+="Notice Type: <strong>"+formData.notice_type+"</strong> already "+operated+".";
				}
			}
