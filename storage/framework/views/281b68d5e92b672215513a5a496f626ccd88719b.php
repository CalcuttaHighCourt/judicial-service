...
<div id="info-panel" class="panel panel-default">
	...
	<div class="panel-body">
		...
		<form id="info-form" class="form-horizontal" role="form" method="POST"
            ...
            <div id="reporting_officer_id-group" class="form-group our-form-group">
				<!-- IIIIIIIIIII -->
				<label for="reporting_officer_id" class="col-md-4 control-label">Reporting Officer </label>
				...
				<div class="col-md-6"><select id="reporting_officer_id" class="form-control info-form-control"
                        ...
                        <div id="reviewing_officer_id-group" class="form-group our-form-group">
				<!-- IIIIIIIIIII -->
				<label for="reviewing_officer_id" class="col-md-4 control-label">Reviewing Officer </label>
