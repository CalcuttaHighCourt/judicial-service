       ...
       /* Display the selected image while uploading the file :: STARTS */ 
        ...
        $(document).on("click",".update", function(){
            ...
            if($(this).val()=='update_basic_details'){
                $.ajax({
                    type:"post",
                    url:"<?php echo e(route('update_basic_details')); ?>",
                    data:{
                        id:$("#fetch_id").val(),
                        jo_code:$("#jo_code").val(),
            ...
            //update contact details
                ...
                $.ajax({
                    type:"post",
                    url:"<?php echo e(route('update_contact_details')); ?>",
                    data:{
                        id:$("#fetch_id").val(),
            ...
            //update profile image
                ...
                if($("#profile_image").val()!=""){
                    $.ajax({
                        method:"POST",
                        url:"<?php echo e(route('update_profile_image')); ?>",
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\judicial-service\resources\views/jo_entry_form/modify_jo_details.blade.php ENDPATH**/ ?>