                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="<?php echo e(url('/login')); ?>" autocomplete="off">
                        ...
                        <div class="form-group<?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                            <label for="email" class="col-md-4 control-label">Username <span class="text-muted">or</span> E-Mail Address</label>
...
<?php $__env->startSection('body_attributes'); ?>
	class=""
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\Judicial-Service\resources\views/auth/login.blade.php ENDPATH**/ ?>