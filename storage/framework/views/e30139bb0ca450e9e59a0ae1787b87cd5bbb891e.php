...
<!-- 								<a class="custom-footer-links" href="<?php echo e(url('page/Cause-List')); ?>">Cause&nbsp;Lists</a> -->

							</div>
							<div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
								<!--<a class="custom-footer-links" target="_blank" rel="noopener noreferrer" href="http://www.courtnic.nic.in/">Case&nbsp;Status</a>-->
								<a class="custom-footer-links" href="<?php echo e(url('/Case-Status')); ?>">Case&nbsp;Status</a>
								
<!-- 								<a class="custom-footer-links" href="<?php echo e(url('page/Case-Status')); ?>">Case&nbsp;Status</a> -->
...
<!-- 							</div> -->
							<div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
								<a class="custom-footer-links" href="<?php echo e(url('page/Pendency-of-Cases')); ?>">Pendency&nbsp;of&nbsp;Cases</a>
...
<!-- 								<a class="custom-footer-links" href="<?php echo e(url('page/Order-Judgement')); ?>">Orders&nbsp;& Judgements</a> -->
							...
							<div class="col-lg-2  col-md-2 col-sm-4 col-xs-6">
								<a class="custom-footer-links" href="<?php echo e(url('page/Important-Links')); ?>">Important&nbsp;Links</a>
								<!--                     <img src="images/portfolio/i6.png" class="img-responsive" alt="" > -->
							</div>
						</div>
						<!--/.row-->
...
<?php /**PATH F:\laragon\www\judicial-officer\resources\views/layouts/sticky_footer.blade.php ENDPATH**/ ?>