            ...
            <div class="tab-pane active" id="basic_details">
               <form class="form" action="##" method="">                 
                  <div class="form-group">
                     <div class="col-xs-6">
                        <label for="jo_name" class="control-label">
						   Name: <?php echo e($profile[0]['officer_name']); ?>
                  ...
                  <div class="form-group">
                     <div class="col-xs-6">
                        <label for="jo_code" class="control-label">
                           JO Code: <?php echo e($profile[0]['jo_code']); ?>
                  ...
                  <div class="form-group">
                     <div class="col-xs-6">
                        <label for="guardian_name" class="control-label">
                           Guardian's Name: <?php echo e($profile[0]['guardian_name']); ?>
                  ...
                  <div class="form-group">
                     <div class="col-xs-6">
                        <label for="guardian_relationship" class="control-label">
                            Guardian Relationship: <?php echo e($profile[0]['gurdian_relation']); ?> 
                        </label>                                                         
                     </div>
				  </div>     
				  <hr>             
                 ...
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="religion_id">
                             Religion: <?php echo e($profile[0]->religion['religion_name']); ?>
                 ...
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="category_id">
                             Category: <?php echo e($profile[0]->caste['caste_name']); ?>	
                        </label>                        
                    </div>
				 </div>
				 <hr>
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="recruitment_batch_id" class="control-label">
                             Recruitment Batch: <?php echo e($profile[0]['recruitment_batch_desc']); ?>
                 ...
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="aadhar_no">
                             Aadhar No.: <?php echo e($profile[0]['aadhaar_no']); ?>	
                        </label>                        				        
                    </div>
				 </div>    
				 <hr>
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="pan_no">
                             PAN No.: <?php echo e($profile[0]['pan_no']); ?>
                 ...
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="gpf_no">
                             GPF No.: <?php echo e($profile[0]['gpf_no']); ?>
                 ...
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="blood_group">
                             Blood Group: <?php echo e($profile[0]['blood_group']); ?>	
                        </label>
                 ...
                 <div class="form-group">
                    <div class="col-xs-6">
                        <label for="identification_mark">
                             Identification Mark: <?php echo e($profile[0]['identification_mark']); ?>
            ...
            <div class="tab-pane" id="contact_details">
               <form class="form" action="##" method="">
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="email_id_1" class="control-label">
                                 Primary Email ID: <?php echo e($profile[0]['email_id_1']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="email_id_2">
                                 Secondary Email ID: <?php echo e($profile[0]['email_id_1']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="email_id_3">
                                 Alternative Email ID: <?php echo e($profile[0]['email_id_3']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="ph_no_1" class="control-label">
                                 Primary Contact No.: <?php echo e($profile[0]['mobile_no_1']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="ph_no_2">
                                 Secondary Contact No.: <?php echo e($profile[0]['mobile_no_2']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="ph_no_3">
                                 Alternative Contact No.: <?php echo e($profile[0]['mobile_no_3']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="home_state" class="control-label">
                                 Home State: <?php echo e($profile[0]->state['state_name']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="home_district" class="control-label">
                                 Home District: <?php echo e($profile[0]->district['district_name']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="home_town" class="control-label">
                                 Home Town: <?php echo e($profile[0]['hometown']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="permanent_address" class="control-label">
                                Permanent Address:  <?php echo e($profile[0]['permanent_address']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-xs-6">
                            <label for="current_address" class="control-label">
                                 Current Address:  <?php echo e($profile[0]['present_address']); ?>	
                            </label>							
                        </div>
                    </div> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\judicial-service\resources\views/profile/index.blade.php ENDPATH**/ ?>