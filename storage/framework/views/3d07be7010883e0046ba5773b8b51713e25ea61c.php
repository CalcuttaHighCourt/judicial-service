...
<div id="info-panel" class="panel panel-default">
    ...
    <li class="nav-item">
      <a class="nav-link" data-toggle="tab" href="#menu1">Judicial Diary</a>
    </li>
    <li class="nav-item">
	...
	<div class="panel-body">
		...
		<form id="info-form add_new" class="form-horizontal" role="form" method="POST"
            ...
            <div id="zone-group" class="form-group row our-form-group">
                <label for="zone" class="col-md-2 ">Previous Zone of Posting:<span id="cur_zone_name" name="cur_zone_name"><?php echo e($zone_pref_details['just_prev_zone']['zone_name']); ?></span></label>
            </div>
            <hr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\Judicial-Service\resources\views/zone_pref_jr/index.blade.php ENDPATH**/ ?>