...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                         ...
                         <?php if(Auth::check() && Auth::user()->user_type->type_name=="Appointment"): ?>
                            <li class="treeview">
                                ...
                                <ul class="treeview-menu">
                                    ...
                                    <li><a href="<?php echo e(url('modify_jo_details')); ?>"> Modify Profile Details</a></li>
        ...
        <?php /**PATH F:\laragon\www\judicial-service\resources\views/layouts/header.blade.php ENDPATH**/ ?>