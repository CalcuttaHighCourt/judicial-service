...
<div class="col-sm-12">
    ...
    <div id="info-panel" class="panel panel-default" style="background:white;">
        <!-- IIIIIIIIIII -->
        <div id="info-panel-heading" class="panel-heading"><h1 align="center">COURT DASHBOARD</h1></div>
        <!-- IIIIIIIIIII -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\judicial-service\resources\views/courts/court_dashboard.blade.php ENDPATH**/ ?>