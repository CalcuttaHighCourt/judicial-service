...
class JoEntryRequest extends FormRequest
{
    ...
    {        
        return [
            ...
            'flag_mode' => 'nullable|alpha|max:20|in:regular,deputation',
            'mode_id' => 'nullable|integer|max:1000|exists:modes,id',
            'rank_id' => 'nullable|integer|max:50|exists:ranks,id',
            ...
            'from_date' => 'nullable|date_format:d-m-Y|after:1900-01-01|before:'.date('Y-m-d'),
